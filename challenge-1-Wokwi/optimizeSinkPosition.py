...
sensor_positions = np.array([(1, 2), (10, 3), (4, 8), (15, 7), (6, 1), (9, 12), (14, 4), (3, 10), (7, 7), (12, 14)])
...
print(f"Shortest sensor lifetime: {min_lifetime:.2f} transmission cycles, which means the lifetime of the system is {min_lifetime:.0f} full transmission cycles.")
print(f"Worst-case sensor with fixed sink position: Sensor nr {worst_case_sensor} with positions {sensor_positions[worst_case_sensor-1]}")
...
print(f"Worst-case sensor with optimal sink position: Sensor nr {worst_case_sensor_optimalSink} with positions {sensor_positions[worst_case_sensor_optimalSink-1]}")
